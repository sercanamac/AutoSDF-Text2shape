...
from models.networks.transformer_networks.rand_transformer_old import RandTransformerOld
from models.networks.pvqvae_networks.auto_encoder import PVQVAE

import utils.util
from utils.util_3d import init_mesh_renderer, render_sdf

class RandTransformerModelOld(BaseModel):
    def name(self):
    ...
    def initialize(self, opt):
        ...
        # init tf model
        self.tf = RandTransformerOld(tf_conf, vq_conf=vq_conf)
