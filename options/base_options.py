...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # model stuff
        self.parser.add_argument('--model', type=str, default='pvqvae', choices=['pvqvae', 'rand_tf', 'resnet2vq', 'bert2vq', 'bert2vqsc', 'bert2vqsc_v4'], help='chooses which model to use.')
